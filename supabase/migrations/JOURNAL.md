...
| `202607221400_grants_service_role_mapping` | Grants lecture `service_role` sur `interclub` (usage schéma + select `club`/`compte`) pour l'écran admin de mapping (T5b, ADR 0002) | _à appliquer_ | _reporté (à la bascule sur `main`)_ |
