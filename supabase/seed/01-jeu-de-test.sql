...
insert into interclub.grimpeur (id, club_id, nom, prenom, annee_naissance, sexe, licence) values
  ('a0000000-0000-0000-0000-0000000000a1', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Ana',    2015, 'F', 100001),
  ('a0000000-0000-0000-0000-0000000000a2', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Bob',    2016, 'H', 100002),
  -- Pool de grimpeurs Club A LIBRES (non engagés) — 8 pour pouvoir atteindre 8/8.
  ('a0000000-0000-0000-0000-0000000000a3', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Chloé',  2015, 'F', 100003),
  ('a0000000-0000-0000-0000-0000000000a4', '11111111-1111-1111-1111-111111111111', 'Alpha',  'David',  2016, 'H', 100004),
  ('a0000000-0000-0000-0000-0000000000a5', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Emma',   2015, 'F', 100005),
  ('a0000000-0000-0000-0000-0000000000a6', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Félix',  2016, 'H', 100006),
  ('a0000000-0000-0000-0000-0000000000a7', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Gaby',   2015, 'F', 100007),
  ('a0000000-0000-0000-0000-0000000000a8', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Hugo',   2016, 'H', 100008),
  ('a0000000-0000-0000-0000-0000000000a9', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Iris',   2015, 'F', 100009),
  ('a0000000-0000-0000-0000-0000000000aa', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Jade',   2016, 'F', 100010),
  ('b0000000-0000-0000-0000-0000000000b1', '22222222-2222-2222-2222-222222222222', 'Bravo',  'Cléo',   2015, 'F', 100011),
  ('b0000000-0000-0000-0000-0000000000b2', '22222222-2222-2222-2222-222222222222', 'Bravo',  'Devi',   2016, 'H', 100012)
on conflict (id) do nothing;
...
insert into interclub.grimpeur (id, club_id, nom, prenom, annee_naissance, sexe, licence) values
  ('adadadad-0000-0000-0000-0000000000c1', '11111111-1111-1111-1111-111111111111', 'Delta', 'Nora', 2011, 'F', 100013),
  ('adadadad-0000-0000-0000-0000000000c2', '11111111-1111-1111-1111-111111111111', 'Delta', 'Owen', 2011, 'H', 100014)
on conflict (id) do nothing;
