...
insert into interclub.grimpeur (id, club_id, nom, prenom, annee_naissance, sexe) values
  ...
  ('a0000000-0000-0000-0000-0000000000a2', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Bob',    2016, 'G'),
  ...
  ('a0000000-0000-0000-0000-0000000000a4', '11111111-1111-1111-1111-111111111111', 'Alpha',  'David',  2016, 'G'),
  ('a0000000-0000-0000-0000-0000000000a5', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Emma',   2015, 'F'),
  ('a0000000-0000-0000-0000-0000000000a6', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Félix',  2016, 'G'),
  ('a0000000-0000-0000-0000-0000000000a7', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Gaby',   2015, 'F'),
  ('a0000000-0000-0000-0000-0000000000a8', '11111111-1111-1111-1111-111111111111', 'Alpha',  'Hugo',   2016, 'G'),
  ...
  ('b0000000-0000-0000-0000-0000000000b2', '22222222-2222-2222-2222-222222222222', 'Bravo',  'Devi',   2016, 'G')
on conflict (id) do nothing;
...
insert into interclub.grimpeur (id, club_id, nom, prenom, annee_naissance, sexe) values
  ...
  ('adadadad-0000-0000-0000-0000000000c2', '11111111-1111-1111-1111-111111111111', 'Delta', 'Owen', 2011, 'G')
on conflict (id) do nothing;
