...
Mot de passe des trois comptes permanents : `interclub`.

| ID | Description | Données (seed) | Utilisé par |
|----|-------------|----------------|-------------|
| JD-ADMIN | Administrateur, sans club | `admin@test.local` · `aaaaaaaa-…-aaaaaaaaaaaa` · rôle `admin` | 17:CT-01/CT-12 · 02 · 03 · 04 · 06 · 07 · 08 · 09 · 10 · 11 · 12 · 13 · 14 · 15 · 16 |
| JD-COACH-A | Coach **permanent** Club A (acteur principal de saisie/engagement) | `coach@test.local` · `cccccccc-…-cccccccccccc` · rôle `coach`, club A | 17:CT-01→CT-14 · 03 · 04 · 06 · 09 · 12 · 13 · 16 |
| JD-SANSMAP | Compte **authentifié sans rôle** (négatif d'accès ; lecture RLS publique) | `sansmapping@test.local` · `55555555-…-555555555555` · **aucune** ligne `compte` | 17:CT-01/CT-13 · 02 · 03 · 04 · 06 · 13 · 16 |

## Clubs

| ID | Description | Données (seed) | Utilisé par |
|----|-------------|----------------|-------------|
| JD-CLUB-A | Club porteur de la rencontre de test | `Club A` · `11111111-…` | 06 · 09 · 13 · 14 · 15 · 17 |
| JD-CLUB-B | Club tiers (grimpeur prêté, négatif de périmètre) | `Club B` · `22222222-…` | 06 · 09 · 13 · 14 · 15 · 17 |

## Rencontre & structure d'épreuve — ENFANT

| ID | Description | Données (seed) | Utilisé par |
|----|-------------|----------------|-------------|
| JD-RENCONTRE-ENFANT | Rencontre **enfant**, Club A, du **19/09/2026**, en phase `competition` (bascule possible en SQL) | `33333333-…-3333` · épreuves voie `…8801`, bloc `…8802`, vitesse `…8803` | 06 · 13 · 14 · 15 · 17 (toute) |
| JD-STRUCTURE-ENFANT | Structure **complète** du gabarit enfant : 4 voies moulinette **M1–M4**, 10 voies tête **T1–T10** (cotations + points + prise valorisée) | voies `…9911`…`…9914` (M1–M4), `…9901` (T1)…`…9929` (T10) sur épreuve `…8801` | 17:CT-04/CT-05/CT-06/CT-07/CT-13 |
| JD-BLOCS-ENFANT | Deux blocs et **tous** leurs paliers par essai : **B1** (1er=4, 2e=3), **B2** (1er=6, 2e=5, 3e=4) | B1 `…9902` (paliers `…99a1`,`…99a2`) · B2 `…9903` (paliers `…99b1`,`…99b2`,`…99b3`) | 17:CT-09/CT-12 |
...
| ID | Description | Données (seed) | Utilisé par |
|----|-------------|----------------|-------------|
| JD-EQUIPE-A1 | Équipe A1 (Club A) composée (Ana + Bob), support des deux vues et de la navigation | `66666666-…-6666` | 17:CT-02/CT-03 · 06 · 13 · 15 |
| JD-EQUIPE-A2 | Équipe A2 (Club A) **vide** (cas limite, remplissage) | `66666666-…-6602` | 06 · 13 · 15 |
| JD-EQUIPE-B1 | Équipe B1 (Club B) composée (Cléo), négatif de périmètre | `77777777-…-7777` | 06 · 13 · 14 · 15 |

## Grimpeurs

| ID | Description | Données (seed) | Utilisé par |
|----|-------------|----------------|-------------|
| JD-ANA-M2 | Enfant, **groupe M2** → enchaîne **M2·M3·M4** (voies moulinette/tête) | `a0000000-…-a1` (2015) · compo A1, `groupe_depart='M2'` | 17:CT-04/CT-05/CT-06/CT-12/CT-13 · 13 · 15 |
| JD-BOB-T1 | Enfant, **groupe T1** → enchaîne **T1·T2·T3** | `a0000000-…-a2` (2016) · compo A1, `groupe_depart='T1'` | 17:CT-02/CT-03 · 13 · 15 |
| JD-CLEO-T2 | Enfant Club B, **groupe T2**, équipe B1 | `b0000000-…-b1` (2015) · compo B1, `groupe_depart='T2'` | 13 · 14 · 15 |
| JD-PRETE-DEVI | Grimpeur **libre** Club B, matière à un **prêt** vers Club A (R35/R36) | `b0000000-…-b2` (2016) · **non** composé au seed | 14 · 13 · 15 · 17 (jeu de données) |
| JD-POOL-LIBRES | **8 grimpeurs libres** Club A (Chloé…Jade) : remplir une équipe à 8/8, ou engager **sans groupe** (cas R9) | `a0000000-…-a3` … `a0000000-…-aa` | 13:remplissage 8/8 · 17:cas R9 (groupe « à définir ») |

## Jetons QR (sessions éphémères)

| ID | Description | Données (seed) | Utilisé par |
|----|-------------|----------------|-------------|
| JD-JETON-COACHTEMP | Jeton **coach temporaire** Club A (scan → session éphémère, droits jour J) | id `55555555-…-5551` · valeur `aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa` | 17:CT-10 · 05 · 06 · 13 |
